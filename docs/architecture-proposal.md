...
![Service architecture — domain boundaries and event flow](images/architecture.png)

*Diagram 1 — service architecture.*

<details>
<summary>Same diagram as inline Mermaid</summary>
...
![Service architecture — domain boundaries and event flow](images/network.png)

*Diagram 2 — service architecture.*
